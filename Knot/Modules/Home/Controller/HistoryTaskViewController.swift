...
class HistoryTaskViewController: BaseViewController {
    ...
    func loadData(){
        DispatchQueue.global().async {
            ...
            self.tasks = CaptureTask.findAll(orderBy: "id")
            self.taskIDS = CaptureTask.getAllIds()
...
//        cell.selectionStyle = .none
    ...
    func taskCellDidSelected(task: CaptureTask?, selected: Bool, indexPath: IndexPath?) {
